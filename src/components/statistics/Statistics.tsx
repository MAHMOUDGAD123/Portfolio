...
export default async function Statistics() {
  ...
  return (
    <div className="mt-[70px] grid w-full animate-settleBottom select-none grid-cols-4 items-center justify-between gap-[30px] motion-reduce:animate-none max-_xl:mx-auto max-_xl:w-fit max-_xl:grid-cols-2 max-_xl:grid-rows-2 max-_xl:gap-0 max-_xl:gap-x-[100px] max-_md:grid-cols-1 max-_md:grid-rows-4 max-_md:gap-4">
      <ExperiencePeriod />
